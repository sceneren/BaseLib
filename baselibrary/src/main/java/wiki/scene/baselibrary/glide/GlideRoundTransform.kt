...
package wiki.scene.baselibrary.glide
 ...
 * 值得注意的是，任何从BitmapPool取出的用于自定义图片变换的辅助Bitmap，如果不经过transform()方法返回，
 * 就必须主动放回BitmapPool或者调用recycle()回收。
 * 2.如果你从BitmapPool拿出多个Bitmap或不使用你从BitmapPool拿出的一个Bitmap，
 * 一定要返回extras给BitmapPool。
 * 3.如果你的图片处理没有替换原始resource(例如由于一张图片已经匹配了你想要的尺寸，
 * 你需要提前返回), transform()`方法就返回原始resource或原始Bitmap。
 *
 *
 */
/**
 ...
 *
 * @Author:         scene
 * @CreateDate:     2019-06-03 18:01
 * @UpdateUser:     更新者：
 * @UpdateDate:     2019-06-03 18:01
 * @UpdateRemark:   更新说明：
 * @Version:        版本号：
 */
